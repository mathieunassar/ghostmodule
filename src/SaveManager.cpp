...
void SaveManager::addData(std::shared_ptr<SaveData> data, const std::string& file)
{
...
std::list<std::shared_ptr<SaveData>> SaveManager::getData(const std::string& dataName) const
{
	return {};
}
