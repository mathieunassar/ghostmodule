...
#ifndef PROTOBUF_INCLUDED_ghost_2fconnection_2fGhost_2eproto
#define PROTOBUF_INCLUDED_ghost_2fconnection_2fGhost_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ghost_2fconnection_2fGhost_2eproto 
...
namespace google {
namespace protobuf {
template<> ::ghost::internal::protobuf::ConnectionConfiguration* Arena::CreateMaybeMessage<::ghost::internal::protobuf::ConnectionConfiguration>(Arena*);
template<> ::ghost::internal::protobuf::ConnectionConfigurationField* Arena::CreateMaybeMessage<::ghost::internal::protobuf::ConnectionConfigurationField>(Arena*);
template<> ::ghost::internal::protobuf::GenericMessage* Arena::CreateMaybeMessage<::ghost::internal::protobuf::GenericMessage>(Arena*);
template<> ::ghost::internal::protobuf::GenericMessageHeader* Arena::CreateMaybeMessage<::ghost::internal::protobuf::GenericMessageHeader>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace ghost {
namespace internal {
...
class GenericMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ghost.internal.protobuf.GenericMessage) */ {
 public:
  ...
  private:
  const ::ghost::internal::protobuf::GenericMessageHeader& _internal_header() const;
  public:
 ...
 private:
  ...
  friend struct ::protobuf_ghost_2fconnection_2fGhost_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline const ::ghost::internal::protobuf::GenericMessageHeader& GenericMessage::_internal_header() const {
  return *header_;
}
...
inline ::ghost::internal::protobuf::GenericMessageHeader* GenericMessage::mutable_header() {
  ...
  if (header_ == NULL) {
    auto* p = CreateMaybeMessage<::ghost::internal::protobuf::GenericMessageHeader>(GetArenaNoVirtual());
    header_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_ghost_2fconnection_2fGhost_2eproto
