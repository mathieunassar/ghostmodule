...
void GhostMessageTester::setupGhostMessages()
{
	...
	setGhostMessageExpectations(_ghostMessage.get(), TEST_GHOST_MESSAGE_CUSTOM_TYPE_NAME, TEST_GHOST_MESSAGE_CUSTOM_SERIALIZED);
	setGhostMessageExpectations(_ghostMessage2.get(), TEST_GHOST_MESSAGE_CUSTOM_TYPE_NAME, TEST_GHOST_MESSAGE_CUSTOM_SERIALIZED);
	setGhostMessageExpectations(_otherTypeGhostMessage.get(), TEST_GHOST_MESSAGE_CUSTOM_OTHER_TYPE_NAME, TEST_GHOST_MESSAGE_CUSTOM_OTHER_SERIALIZED);
	setGhostMessageExpectations(_emptyGhostMessage.get(), TEST_GHOST_MESSAGE_CUSTOM_TYPE_NAME, "");
}

void GhostMessageTester::setGhostMessageExpectations(MessageMock* message, const std::string& type, const std::string& serialized)
{
