...
namespace ghost
{
	...
	public:
		 ...
		 * as destination storage file. Leave empty to remove ghost::SaveData objects with the matching name for all file names.
		 * 
		...
		/**
		 * @brief Searches the manager for all ghost::SaveData objects with the provided name and returns them as a map. The key
		 * used by the returned map corresponds to the file names used for the ghost::SavedData as a destination storage file.
		 * 
